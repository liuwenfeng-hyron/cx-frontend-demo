...
export class JsonLdObject {
  ...
  private getNamespaceUrl(prefix: string): string {
    switch (prefix) {
      ...
      case 'dct': return 'http://purl.org/dc/terms/'; // Added on 2025.8.18
      case 'cx-common': return 'https://w3id.org/catenax/ontology/common#'; // Added on 2025.8.18
      case 'bmw': return 'http://bmwgroup.com/catenax/taxonomy#'; // Added on 2025.8.18
