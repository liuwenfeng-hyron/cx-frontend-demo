...
export class ContractAgreementService {
    ...
    // Added By Nri On 2025.4.24 Start
    /**
     * Gets Negotiation by agreementId
     * @param agreementId
     */
    public getNegotiation(agreementId: string): Observable<any> {
      return from(this.contractAgreements.getNegotiation(agreementId))
    }
    // Added By Nri On 2025.4.24 End
