export enum SubmodelTemplate {
  submodel_pcf = `{
    ...
    "description": [
        {
            "language": "en",
            "text": "A Product (Carbon) Footprint represents the carbon footprint of a product with values as specified in the Catena-X PCF Rulebook (Version 3.0.0) in accordance with the WBCSD (World Business Council for Sustainable Development) Pathfinder framework and the technical specifications for PCF Data Exchange (Version 2.0.0) from the WBCSD/ PACT initiative."
        }
    ],
    "administration": {},
    "id": "urn:samm:io.catenax.pcf:7.0.0#Pcf/submodel",
    "kind": "Template",
    "semanticId": {
